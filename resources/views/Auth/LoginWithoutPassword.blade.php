    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 gradient-panel relative overflow-hidden items-center justify-center p-12">
            ...
            <div class="relative z-10 text-white max-w-md">
                ...
                <h1 class="text-4xl font-bold mb-4 leading-tight">No password, no problem</h1>
                <p class="text-white/80 text-lg leading-relaxed">Enter your email and we'll send you a secure link to log in instantly.</p>
                ...
                <div class="mt-10 space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-white/90">No password to remember</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center shrink-0">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                        </div>
                        <span class="text-white/90">Link expires for extra security</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center shrink-0">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                        </div>
                        <span class="text-white/90">Delivered straight to your inbox</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md fade-in">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Enter Email Address</h2>
                    <p class="text-gray-500">We'll send a magic login link to your inbox</p>
                </div>
                ...
                <form action="{{ Route('send_link') }}" method="POST" class="space-y-5">
                    @csrf
