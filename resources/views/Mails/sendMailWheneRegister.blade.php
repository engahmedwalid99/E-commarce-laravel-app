...
<title>Register Successful - ShopZone</title>
</head>
    ...
    <tr>
        <td align="center">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 8px 30px rgba(0,0,0,0.08);">
                ...
                <tr>
                    <td style="padding:20px 34px 10px; text-align:center;">
                        ...
                        <p style="font-size:15px; color:#5a5470; line-height:1.8; margin:0;">
                            ...
                            You have successfully create account in to your <strong>ShopZone</strong>.
                        ...
                        @elseif ($user->role == 'seller')
                            <p style="font-size:15px; color:#5a5470; line-height:1.8; margin:0;">Welcome to ShopZone! <br> As a seller, you can now list your products and manage your store.</p>
                        @else
                ...
                <tr>
                    <td style="text-align:center; padding:32px 34px 8px;">
                        <a href=""
                           style="display:inline-block; background:linear-gradient(135deg, #6C3CE9, #9B5CFF); color:#ffffff; text-decoration:none; font-size:15px; font-weight:700; padding:14px 40px; border-radius:50px; box-shadow:0 6px 18px rgba(108,60,233,0.35);">
                            Go to My Account
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="background-color:#faf9ff; padding:22px 30px; text-align:center; border-top:1px solid #f0ecff;">
                        ...
                        <p style="font-size:12px; color:#c3bcd6; margin:0;">
                            This is an automated email, no need to reply have a nice time ⭐💓.
                        </p>
                    </td>
                </tr>
            </table>
